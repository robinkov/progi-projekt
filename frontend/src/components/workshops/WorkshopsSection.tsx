// src/components/workshops/WorkshopsSection.tsx
...
const WorkshopsSection: React.FC = () => {
    return (
        <section className="py-5 border-b border-gray-300">
            ...
            <SectionHeader title="Radionice (aktualne)" />

            {/* 2. Workshop List Container (Horizontal Scroll) */}
            <div className="
        flex 
        overflow-x-auto 
        py-4 
      ...
      ">
        ...
        ">
          ...
          ">
                        <span className="font-semibold text-sm">Pogledaj još radionica</span>
